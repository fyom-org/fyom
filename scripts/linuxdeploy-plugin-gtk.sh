#!/bin/bash
# PORTED_FROM_SOIA @ 9e22064 (src-tauri/scripts/linuxdeploy-plugin-gtk.sh)
#
# Verbatim port from soia (GPL-3.0-only). Tauri's AppImage bundler shells out
# to this script to pull GTK runtime libs into the AppDir. The plugin itself
# is upstream from soia (linuxdeploy project) — soia vendored it; fyom vendors
# the same version.
#
